...
class Tetromino{
    ...
    drawBlock(x,y,id){
        ...
        this.drawTriangle(x,y,x+this.cellSize,y,x,y+this.cellSize,palette.leftTriangle);
        this.drawTriangle(x+this.cellSize,y,x+this.cellSize,y+this.cellSize,x,y+this.cellSize,palette.rightTriangle);
        this.drawSquare(x+margin,y+margin,this.cellSize - (margin * 2),palette.square);
    }
